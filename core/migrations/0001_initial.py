    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index_page', models.BooleanField(default=True)),
                ('publish', models.BooleanField(default=False)),
                ('cat_level', models.CharField(blank=True, choices=[('c', 'Country'), ('t', 'Teams'), ('p', 'Players')], max_length=1, null=True)),
                ('avatar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_related', to='core.imagecollection')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='parent_cat', to='core.wikicategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index_page', models.BooleanField(default=True)),
                ('publish', models.BooleanField(default=False)),
                ('full_name', models.CharField(blank=True, help_text='For team and game, use small name like Na’Vi and CS:GO', max_length=50, null=True)),
                ...
                ('history', ckeditor_uploader.fields.RichTextUploadingField(blank=True)),
                ('career', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
                ('team_history', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
                ('achievements', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
                ('controversies', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
                ...
                ('related', models.ManyToManyField(blank=True, to='core.wiki')),
                ('tags', models.ManyToManyField(blank=True, related_name='wiki_tags', to='core.wikicategory')),
                ('writer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='wiki_writer', to='core.author')),
            ],
            options={
                'verbose_name': 'Wiki',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index_page', models.BooleanField(default=True)),
                ('publish', models.BooleanField(default=False)),
                ('active_players', models.ManyToManyField(related_name='active_roster', to='core.wiki')),
                ('avatar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_related', to='core.imagecollection')),
                ('esports_game', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.gameprofile')),
                ('team_wiki', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.wiki')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('writer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.author')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref', ckeditor.fields.RichTextField(blank=True)),
                ('avatar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_related', to='core.imagecollection')),
                ('tags', models.ManyToManyField(blank=True, related_name='news_tags', to='core.newscategory')),
                ('writer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='news_writer', to='core.author')),
            ],
            options={
                'verbose_name': 'News',
        ...
        migrations.AddField(
            ...
            name='avatar',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_related', to='core.imagecollection'),
        ),
        migrations.AddField(
            model_name='gameprofile',
            name='game_wiki',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.wiki'),
        ),
    ]
